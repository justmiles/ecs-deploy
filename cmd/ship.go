...
import (
	...
	"github.com/justmiles/ecs-deploy/deployer"
...
func init() {
	...
	shipCmd.Flags().BoolVar(&noMemoryReservation, "no-memory-reservation", false, "Do not automatically adjust the memory reservation")
...
var shipCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		results, err := deployer.PerformDeployment(deployer.DeploymentOptions{
			...
			DisableMemoryReservation: noMemoryReservation,
